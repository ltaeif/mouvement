 ...
 * @version $Id$
 *
 * @method Application_Model_Inscription_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Inscription_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Inscription_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Inscription_Rowset find()
 *
 */
abstract class Application_Model_Inscription_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'codeins',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Inscription_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Inscription_Rowset';
  ...
  'password' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['codeins']) && !empty($params['codeins'])) {
            $select->where('codeins = ?', $params['codeins']);
        }
