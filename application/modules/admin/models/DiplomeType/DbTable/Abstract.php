...
/**
 * Definition class for table diplome_type.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_DiplomeType_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_DiplomeType_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_DiplomeType_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_DiplomeType_Rowset find()
 *
 */
abstract class Application_Model_DiplomeType_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
    protected $_name = 'diplome_type';
  ...
  0 => 'type',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_DiplomeType_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_DiplomeType_Rowset';
