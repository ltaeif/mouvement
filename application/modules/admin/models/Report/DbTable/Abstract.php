...
/**
 * Definition class for table report.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Report_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Report_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Report_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Report_Rowset find()
 *
 */
abstract class Application_Model_Report_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'codedem',
    ...
    protected $_referenceMap = array(        
        ...
        'section_actuelle' => array(
            'columns' => 'section_actuelle',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Report_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Report_Rowset';
  ...
  'causerepsante' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['causereport']) && !empty($params['causereport'])) {
            $select->where('causereport = ?', $params['causereport']);
        }

        if (isset($params['causerepperso']) && !empty($params['causerepperso'])) {
            $select->where('causerepperso = ?', $params['causerepperso']);
        }

        if (isset($params['causerepsante']) && !empty($params['causerepsante'])) {
            $select->where('causerepsante = ?', $params['causerepsante']);
        }
