...
/**
 * Definition class for table diplome.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Diplome_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Diplome_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Diplome_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Diplome_Rowset find()
 *
 */
abstract class Application_Model_Diplome_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'Application_Model_Parcours_DbTable',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Diplome_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Diplome_Rowset';
  ...
  'libelle' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['id_diplome']) && !empty($params['id_diplome'])) {
            $select->where('id_diplome = ?', $params['id_diplome']);
        }
