...
/**
 * Definition class for table domaine.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Domaine_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Domaine_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Domaine_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Domaine_Rowset find()
 *
 */
abstract class Application_Model_Domaine_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'Application_Model_Parcours_DbTable',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Domaine_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Domaine_Rowset';
  ...
  'description' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['id_domaine']) && !empty($params['id_domaine'])) {
            $select->where('id_domaine = ?', $params['id_domaine']);
        }
