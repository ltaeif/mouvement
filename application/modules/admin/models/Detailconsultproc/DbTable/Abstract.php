 ...
 * @version $Id$
 *
 * @method Application_Model_Detailconsultproc_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Detailconsultproc_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Detailconsultproc_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Detailconsultproc_Rowset find()
 *
 */
abstract class Application_Model_Detailconsultproc_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
    protected $_name = 'detailconsultproc';
  ...
  1 => 'codeproclm',
    ...
    protected $_referenceMap = array(        
        ...
        'codeproclm' => array(
            'columns' => 'codeproclm',
            'refTableClass' => 'Application_Model_Proclamation_DbTable',
            'refColumns' => 'codeproclm'
        )
    );
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Detailconsultproc_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Detailconsultproc_Rowset';
