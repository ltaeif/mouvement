 ...
 * @version $Id$
 *
 * @method Application_Model_Chparcours_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Chparcours_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Chparcours_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Chparcours_Rowset find()
 *
 */
abstract class Application_Model_Chparcours_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
    protected $_name = 'chparcours';
  ...
  0 => 'codedem',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Chparcours_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Chparcours_Rowset';
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['etat']) && !empty($params['etat'])) {
            ...
            $select->join(array('demande' => 'demande'),
                'chparcours.codedem = demande.codedem')
        ...
        if (isset($params['niveau_demande']) && !empty($params['niveau_demande'])) {
            $select->where('niveau_demande = ?', $params['niveau_demande']);
        }
