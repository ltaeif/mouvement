...
/**
 * Definition class for table pays.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Pays_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Pays_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Pays_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Pays_Rowset find()
 *
 */
abstract class Application_Model_Pays_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'Application_Model_Etudiant_DbTable',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Pays_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Pays_Rowset';
  ...
  'iso' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['iso']) && !empty($params['iso'])) {
            $select->where('iso = ?', $params['iso']);
        }
        ...
        if (isset($params['_kw']) && !empty($params['_kw'])) {
            ...
            if ('all' === $searchMode || 'iso' === $searchMode) {
                $searchWheres[] = $dbAdapter->quoteInto('iso LIKE ?', "%$keywords%");
            }
