...
/**
 * Definition class for table type_diplome.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_TypeDiplome_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_TypeDiplome_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_TypeDiplome_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_TypeDiplome_Rowset find()
 *
 */
abstract class Application_Model_TypeDiplome_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
    protected $_name = 'type_diplome';
  ...
  0 => 'type',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_TypeDiplome_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_TypeDiplome_Rowset';
     ...
     *
     * @return Application_Model_TypeDiplome_Row
     */
