...
/**
 * Definition class for table directeur.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Directeur_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Directeur_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Directeur_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Directeur_Rowset find()
 *
 */
abstract class Application_Model_Directeur_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
    protected $_name = 'directeur';
  ...
  0 => 'Application_Model_Etablissement_DbTable',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Directeur_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Directeur_Rowset';
  ...
  'Description' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['grade']) && !empty($params['grade'])) {
            $select->where('grade = ?', $params['grade']);
        }
        ...
        if (isset($params['_kw']) && !empty($params['_kw'])) {
            ...
            if ('all' === $searchMode || 'grade' === $searchMode) {
                $searchWheres[] = $dbAdapter->quoteInto('grade LIKE ?', "%$keywords%");
            }
