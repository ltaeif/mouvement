...
/**
 * Definition class for table universite.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Universite_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Universite_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Universite_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Universite_Rowset find()
 *
 */
abstract class Application_Model_Universite_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
    protected $_name = 'universite';
  ...
  0 => 'Application_Model_Etablissement_DbTable',
  1 => 'Application_Model_UniversiteLang_DbTable',
);
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Universite_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Universite_Rowset';
  ...
  'iduniversite' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['iduniversite']) && !empty($params['iduniversite'])) {
            $select->where('iduniversite = ?', $params['iduniversite']);
        }
