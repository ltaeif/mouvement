...
/**
 * Definition class for table mention.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Mention_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Mention_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Mention_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Mention_Rowset find()
 *
 */
abstract class Application_Model_Mention_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
    protected $_name = 'mention';
  ...
  0 => 'Application_Model_Parcours_DbTable',
);
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Mention_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Mention_Rowset';
  ...
  'description' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['id_mention']) && !empty($params['id_mention'])) {
            $select->where('id_mention = ?', $params['id_mention']);
        }
